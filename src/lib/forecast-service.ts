...
export class ForecastService {
     ...
     */
    public async fetchSnapshot(config: EffectiveConfig): Promise<ForecastSnapshot> {
    ...
    private async resolveLocation(config: EffectiveConfig): Promise<LocationContext> {
